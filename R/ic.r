...
#' dimension. Parameters used are the same as the ones used elsewhere
#' in the rEDM library or just self explanatory.
#' @param ts the time series for which we plot AIC
#' @param E time lags
#' @param lib the library indices we use for training
#' @param pred the indices we use for testing predicition
#' @param criterion either AIC or BIC
#' @param showPlot show a plot or not
#' @param title the title of the plot. If not empty string then plot shown
#' automatically
#' @return A data.frame that contains time lags and their corresponding
