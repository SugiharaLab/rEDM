...
---
# Abstract
// existence of methods for reconstructing dynamics from time series data
// many algorithms exist for doing so, to our knowledge, no existence of a general software package
// rEDM uses Rcpp and RcppEigen to implement 
