...
auto SimplexArgs = r::List::create(
    ...
    r::_["embedded"]        = false,
    //r::_["const_predict"]   = false, // Rcpp 20 arg limit
    r::_["verbose"]         = false,
...
auto SMapArgs = r::List::create(
    ...
    r::_["columns"]         = std::string(""),
    r::_["target"]          = std::string(""),
    //r::_["smapCoefFile"]  = std::string(""), // Rcpp 20 arg limit
    //r::_["smapSVFile"]    = std::string(""), // Rcpp 20 arg limit
    //r::_["solver"]        = std::string(""), // Not supported by glmnet
    r::_["embedded"]        = false,
    //r::_["const_predict"] = false,           // Rcpp 20 arg limit
    r::_["verbose"]         = false,
    r::_["validLib"]        = std::vector<bool>(),
...
auto CCMArgs = r::List::create( 
    ...
    r::_["sample"]          = 0,
    r::_["random"]          = true,
    //r::_["replacement"]   = false,             // Rcpp 20 arg limit
    r::_["seed"]            = 0,
    r::_["embedded"]        = false,
